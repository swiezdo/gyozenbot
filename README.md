...
- **SQLite** - прямой доступ к базе данных miniapp_api
...
- **Команды**: `!волны` - показать информацию о волнах
- **Команда**: `!записатьволны` - записать новую информацию (только для админов)
- **Данные**: хранятся в `json/waves.json`
...
- **MINI_APP_URL** - URL Mini App (GitHub Pages)
...
- **REST API**: получение данных билдов, создание скриншотов профилей
